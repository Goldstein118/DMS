...
switch ($action) {
    ...
    if ($target && $contextAction) {
        ...
        checkAccess($conn, $user_id, 'tb_armada', 48); // View access
    }
        require __DIR__ . '/actions/select_armada.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_armada', 49); // Create access
        require  __DIR__ . '/actions/create_armada.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_armada', 50); // Edit access
        require  __DIR__ . '/actions/update_armada.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_armada', 51); // Delete access
        require  __DIR__ . '/actions/delete_armada.php';
        break;
