...
switch ($action) {
    case 'select':
        ...
        if ($target && $contextAction) {
            ...
            checkAccess($conn, $user_id, 'tb_data_biaya', 68); // View access
        }
        require __DIR__ . '/actions/select_data_biaya.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_data_biaya', 69); // Create access
        require  __DIR__ . '/actions/create_data_biaya.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_data_biaya', 70); // Edit access
        require  __DIR__ . '/actions/update_data_biaya.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_data_biaya', 71); // Delete access
        require  __DIR__ . '/actions/delete_data_biaya.php';
        break;
