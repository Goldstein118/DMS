...
switch ($action) {
    ...
    if ($target && $contextAction) {
        ...
        checkAccess($conn, $user_id, 'tb_frezzer', 52); // View access
    }
        require __DIR__ . '/actions/select_frezzer.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_frezzer', 53); // Create access
        require  __DIR__ . '/actions/create_frezzer.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_frezzer', 54); // Edit access
        require  __DIR__ . '/actions/update_frezzer.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_frezzer', 55); // Delete access
        require  __DIR__ . '/actions/delete_frezzer.php';
        break;
