...
switch ($action) {
    ...
    if ($target && $contextAction) {
        ...
        checkAccess($conn, $user_id, 'tb_gudang', 40); // View access
    }
        require __DIR__ . '/actions/select_gudang.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_gudang', 41); // Create access
        require  __DIR__ . '/actions/create_gudang.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_gudang', 42); // Edit access
        require  __DIR__ . '/actions/update_gudang.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_gudang', 43); // Delete access
        require  __DIR__ . '/actions/delete_gudang.php';
        break;
