...
switch ($action) {
    case 'select':
        ...
        if ($target && $contextAction) {
            ...
            checkAccess($conn, $user_id, 'tb_pembelian', 64); // View access
        }
        require __DIR__ . '/actions/select_pembelian.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_pembelian', 65); // Create access
        require  __DIR__ . '/actions/create_pembelian.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_pembelian', 66); // Edit access
        require  __DIR__ . '/actions/update_pembelian.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_pembelian', 67); // Delete access
        require  __DIR__ . '/actions/delete_pembelian.php';
        break;
