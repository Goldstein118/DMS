...
switch ($action) {
    case 'select':
        ...
        if ($target && $contextAction) {
            ...
            checkAccess($conn, $user_id, 'tb_penjualan', 80); // View access
        }
        require __DIR__ . '/actions/select_penjualan.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_penjualan', 81); // Create access
        require  __DIR__ . '/actions/create_penjualan.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_penjualan', 82); // Edit access
        require  __DIR__ . '/actions/update_penjualan.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_penjualan', 83); // Delete access
        require  __DIR__ . '/actions/delete_penjualan.php';
        break;
