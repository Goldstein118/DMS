...
switch ($action) {
    case 'select':
        ...
        if ($target && $contextAction) {
            ...
            checkAccess($conn, $user_id, 'tb_promo', 56); // View access
        }
        require __DIR__ . '/actions/select_promo.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_promo', 57); // Create access
        require  __DIR__ . '/actions/create_promo.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_promo', 58); // Edit access
        require  __DIR__ . '/actions/update_promo.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_promo', 59); // Delete access
        require  __DIR__ . '/actions/delete_promo.php';
        break;
