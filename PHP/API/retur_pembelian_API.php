...
switch ($action) {
    case 'select':
        ...
        if ($target && $contextAction) {
            ...
            checkAccess($conn, $user_id, 'tb_retur_pembelian', 76); // View access
        }
        require __DIR__ . '/actions/select_retur_pembelian.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_retur_pembelian', 77); // Create access
        require  __DIR__ . '/actions/create_retur_pembelian.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_retur_pembelian', 78); // Edit access
        require  __DIR__ . '/actions/update_retur_pembelian.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_retur_pembelian', 79); // Delete access
        require  __DIR__ . '/actions/delete_retur_pembelian.php';
        break;
