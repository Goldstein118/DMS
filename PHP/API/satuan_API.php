...
switch ($action) {
    case 'select':
        ...
        if ($target && $contextAction) {
            ...
            checkAccess($conn, $user_id, 'tb_satuan', 60); // View access
        }
        require __DIR__ . '/actions/select_satuan.php';
        break;

    case 'create':
        checkAccess($conn, $user_id, 'tb_satuan', 61); // Create access
        require  __DIR__ . '/actions/create_satuan.php';
        break;

    case 'update':
        checkAccess($conn, $user_id, 'tb_satuan', 62); // Edit access
        require  __DIR__ . '/actions/update_satuan.php';
        break;

    case 'delete':
        checkAccess($conn, $user_id, 'tb_satuan', 63); // Delete access
        require  __DIR__ . '/actions/delete_satuan.php';
        break;
