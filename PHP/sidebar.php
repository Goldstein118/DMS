    ...
    <ul class="list-unstyled ps-0 flex-grow-1">
      ...
      <li class="mb-1">
        <button
          class="btn btn-toggle d-inline-flex align-items-center rounded border-0"
          data-bs-toggle="collapse"
          data-bs-target="#pembelian-collapse"
          aria-expanded="true">
          <i
            class="bi bi-chevron-right toggle-icon"
            data-bs-target="#pembelian-collapse"></i>
          Pembelian
        </button>
        <div class="collapse hide" id="pembelian-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li>
              <a
            ...
            <li>
              <a
                href="<?php echo $_ENV['BASE_URL']; ?>index.php?page=tabel_retur_pembelian"
                class="link-dark d-inline-flex text-decoration-none rounded <?php echo ($_GET['page'] ?? '') === 'tabel_retur_pembelian' ? 'active' : ''; ?>"> Retur Pembelian</a>
            </li>
          </ul>
        </div>
      </li>
