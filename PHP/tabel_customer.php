    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_customer" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label for="ktp_image" class="form-label">Upload Gambar KTP:</label>
          ...
          <div>
            <label for="npwp_image" class="form-label">Upload Gambar NPWP</label>
            <input type="file" class="form-control" id="npwp_image" name="npwp_image" accept=".jpg,.jpeg,.png">
            <img id="npwp" src="" width="100px" height="100px"/>
          </div>
        </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_customer" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label for="update_ktp_image" class="form-label">Upload Gambar KTP:</label>
          ...
          <div>
            <label for="update_npwp_image" class="form-label">Upload Gambar NPWP</label>
