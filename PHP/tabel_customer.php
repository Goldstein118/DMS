        ...
        <form id="form_customer" enctype="multipart/form-data">
          ...
          <div class="row g-2">
            <div class="col">
              ...
              <div id="div_npwp_customer">

                <label class="form-label mb-0 mt-2" for="npwp_customer">NPWP:<i class="bi bi-asterisk text-danger align-middle "></i></label>
        ...
        <form id="form_customer" enctype="multipart/form-data">
          <div class="row g-2">
            <div class="col">
              ...
              <div id="update_div_npwp_customer">
            ...
            <div class="col"> <label class="form-label mb-0 mt-2" for="update_nitko">Nitku:</label>
