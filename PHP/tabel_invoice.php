    ...
    <div class="modal-dialog  modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select class="form-select" id="update_purchase_order">
                </select>
                ...
                <div class="card mt-3" style="display: none;" id="update_purchase_order_card">
                    <div class="card-header">Update Purchase Order</div>
                                    ...
                                    <div class="accordion-body">
                                        <div class="row gap-2">
                                            <div class="col">
                                                ...
                                                <input class="form-control" type="text" id="tanggal_po" name="update_tanggal_po" value="">
