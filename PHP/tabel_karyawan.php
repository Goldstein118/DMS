    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input class="form-control" type="text" id="update_address_karyawan" name="address_karyawan_update">
          <label class="form-label" for="update_nik_karyawan">NIK:</label>
          <input class="form-control" type="text" id="update_nik_karyawan" name="nik_karyawan_update">
          <label class="form-label" for="update_npwp_karyawan">NPWP:</label>
          <input class="form-control" type="text" id="update_npwp_karyawan" name="npwp_karyawan" value="">
          <label class="form-label" for="status_karyawan">Status:<i class="bi bi-asterisk text-danger align-middle "></i></label> 
