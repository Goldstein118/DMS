...
<!-- Modal -->
<div class="modal fade" id="modal_promo_copy" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Copy Promo</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <div class="col">
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col">
                                        <input class="form-control d-none" type="text" id="copy_promo_id" name="copy_promo_id" value="" disabled>
                                        <label class="form-label" for="copy_nama_promo">Nama:<i class="bi bi-asterisk text-danger align-middle "></i></label>
                                        <input class="form-control" type="text" id="copy_nama_promo" name="copy_nama_promo" value="">
                                        <label class="form-label mb-0 mt-2" for="copy_tanggal_berlaku">Tanggal Berlaku:<i class="bi bi-asterisk text-danger align-middle "></i></label>
                                        <input type="text" class="form-control" id="copy_tanggal_berlaku" name="copy_tanggal_berlaku" />
                                        <label class="form-label mb-0 mt-2" for="copy_tanggal_selesai">Tanggal Selesai:<i class="bi bi-asterisk text-danger align-middle "></i></label>
                                        <input type="text" class="form-control" id="copy_tanggal_selesai" name="copy_tanggal_selesai" />
                                        <label class="form-label mb-0 mt-2" for="copy_quota">Quota:</label>
                                        <input class="form-control" type="number" min="0" id="copy_quota">
                                        <label class="form-label mb-0 mt-2" for="copy_status_promo">Status:</label>
                                        <select class="form-select" id="copy_status_promo">
                                            <option value="aktif">Aktif</option>
                                            <option value="nonaktif">Non Aktif</option>
                                        </select>
                                    ...
                                    <div class="col">
                                        ...
                                        <div id="copy_toggle_jenis_bonus" style="display: none;">
                                            <label class="form-label mb-0 mt-2" for="copy_jenis_diskon">Jenis Diskon:<i class="bi bi-asterisk text-danger align-middle "></i></label>
                                            <select class="form-select" id="copy_jenis_diskon">
                                                <option value="nominal">Nominal</option>
                                                <option value="persen">Persen</option>
                                            </select>
                                            <label class="form-label mb-0 mt-2" for="copy_jumlah_diskon">Jumlah Diskon:<i class="bi bi-asterisk text-danger align-middle "></i></label>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-header">Promo Kondisi</div>
                            <div class="card-body" id="copy_promo_kondisi_card_body">
                                <button class="btn btn-primary btn-sm mb-2" id="copy_promo_kondisi_button">
                                    <i class="bi bi-plus-circle"></i> Tambah
                                </button>

                                <table
                                    class="table table-hover table-bordered table-sm "
                                    id="copy_jenis_promo_kondisi">
                                    <thead id="copy_jenis_promo_kondisi_thead">
                                        <tr>
                                            <th>Jenis</th>
                                            <th>Kriteria</th>
                                            <th>Kondisi</th>
                                    ...
                                    <tbody id="copy_jenis_promo_kondisi_tbody">
                                    </tbody>
                                </table>
                    ...
                    <div class="card" id="copy_card_promo_3">
                        <div class="card-header">Promo Bonus Barang</div>
                        <div class="card-body" id="copy_promo_bonus_card_body">
                            <button class="btn btn-primary btn-sm mb-2" id="copy_promo_bonus_barang_button">
                                <i class="bi bi-plus-circle"></i> Tambah
                            </button>
                            <table id="copy_table_bonus_barang" class="table table-hover table-bordered table-sm ">
                                <thead id="copy_table_bonus_barang_thead">
                                    <tr>
                                        <th>Produk</th>
                                        <th>Jumlah Qty</th>
                                        <th>Jenis Diskon</th>
                                ...
                                <tbody id="copy_table_bonus_barang_tbody">
            ...
            <div class="modal-footer">
                <button id="copy_submit_promo" type="button" class="btn btn-primary">Simpan</button>
            </div>
        </div>
    </div>
</div>
