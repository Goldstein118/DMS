                ...
                <div id="collapse_main" class="accordion-collapse collapse"
                  ...
                  <div class="accordion-body">
                    <div class="permission-group">
                      <p class="label-check-box">Table Karyawan</p>

                      <div class="permission-grid">
                        <input class="form-check-input form-check-inline" type="checkbox" id="check_all_karyawan" autocomplete="off">
                        <label class="form-check-label" for="check_all_karyawan">Select All</label>
                      </div>

                      <div class="permission-grid">
                        <input class="form-check-input perm-checkbox form-check-inline" type="checkbox" id="check_view_karyawan">
                        <label class="form-check-label" for="check_view_karyawan">View</label>
                      </div>

                      <div class="permission-grid">
                        <input class="form-check-input perm-checkbox form-check-inline" type="checkbox" id="check_create_karyawan">
                        <label class="form-check-label" for="check_create_karyawan">Create</label>
                      </div>

                      <div class="permission-grid">
                        <input class="form-check-input perm-checkbox form-check-inline" type="checkbox" id="check_edit_karyawan">
                        <label class="form-check-label" for="check_edit_karyawan">Edit</label>
                      </div>

                      <div class="permission-grid">
                        <input class="form-check-input perm-checkbox form-check-inline" type="checkbox" id="check_delete_karyawan">
...
<div class="permission-group">
  <div class="permission-row">
    ...
    <label class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" id="check_all_karyawan">
      Select All
    </label>

    <label class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" id="check_view_karyawan">
      View
    </label>

    <label class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" id="check_create_karyawan">
      Create
    </label>

    <label class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" id="check_edit_karyawan">
      Edit
    </label>

    <label class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" id="check_delete_karyawan">
      Delete
    </label>
  </div>
</div>
                    ...
                    <div class="permission-group">
                      <p class="label-check-box">Table User</p>
                    ...
                    <div class="permission-group">
                      <p class="label-check-box">Table Role</p>
                    ...
                    <div class="permission-group">
                      <p class="label-check-box">Table Supplier</p>
                    ...
                    <div class="permission-group">
                      <p class="label-check-box">Table Customer</p>
                    ...
                    <div class="permission-group">
                      <p class="label-check-box">Table Channel</p>
