...
<body class="container py-4">
    <header class="mb-4">
        ...
        <div class="text-center">
            <h1 style="display: block">Retur Pembelian</h1>
    ...
    <main>
        ...
        <table
            ...
            id="retur_detail_pembelian">
            <thead id="view_retur_detail_pembelian_thead">
                <tr>
            ...
            <tbody id="view_detail_retur_pembelian_tbody"></tbody>
            <tfoot id="view_detail_retur_pembelian_tfoot">
                <tr>
    ...
    <?php
    ?>
    <script type="module" src="<?php echo $_ENV['BASE_URL']; ?>../JS/view_retur_pembelian.js"></script>
