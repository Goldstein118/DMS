...
<body class="container py-4">
    <header class="mb-4">
        ...
        <div id="invoice_header" style="display: none;">
            ...
            <button type="button" class="btn btn-outline-primary btn-sm no_print" id="print_invoice" onclick="window.print()">
        ...
        <!-- <div id="pengiriman_header" style="display: none;">
            ...
            <button type="button" class="btn btn-outline-primary btn-sm no_print" id="print" onclick="window.print()">
                <i class="bi bi-printer"></i> Print
            </button>
            ...
            <span class="text-muted " style="float : inline-start ;" id="alamat"></span>
        ...
        <div id="gudang_header" style="display: none;">
            ...
            <div style="display: grid; 
                    ...
                    justify-content: end;">
                <span class="text-muted view_tanggal_penjualan" style="float : inline-end ; " id="view_tanggal_penjualan"></span>
                <span class="text-muted" style="float : inline-end ; " id="view_tanggal_kirim"></span>
    ...
    <main>
        ...
        <!-- <div id="pengiriman" style="display: none;">
            ...
            <table
                ...
                <tfoot id="view_detail_penjualan_tfoot">
                    ...
                    <tr>
                        ...
                        <td colspan="1" rowspan="1" id="keterangan_pengiriman" style="text-align: right;">
                        </td>
                    </tr>
                </tfoot>
            </table>
            <div class="text-center">
                <div class="row gap-2">
                    <div class="col">
                        <p class="mb-5">Diantar oleh,</p>
                        <p class="mt-5">Driver</p>
                    </div>
                    <div class="col">
                        <p class="mb-5">Diterima oleh,</p>
                        <p class="mt-5" id="nama_customer_kirim"></p>
                    </div>
                </div>
            </div>
            ...
            <table
                ...
                <tfoot id="view_detail_penjualan_tfoot">
                    ...
                    <tr>
                        ...
                        <td colspan="1" rowspan="1" id="keterangan_gudang" style="text-align: right;">
                        </td>
                    </tr>
                </tfoot>
            </table>
