...
window.Picker = (function (e, t) {
    ...
    function s() {
      return n._.node(
        ...
        n._.node(
          ...
          n._.node(
            "div",
            n._.node("div", h.component.nodes(u.open), d.box),
            d.wrap
          ),
          d.frame
        ),
    ...
    var u = { id: Math.abs(~~(1e9 * Math.random())) },
      ...
      h = (p.prototype = {
        ...
        start: function () {
          return u && u.start
            ...
            : ((u.methods = {}),
              ...
              (u.open = !1),
              (u.type = r.type),
              (r.autofocus = r == document.activeElement),
              (r.type = "text"),
              (r.readOnly = !0),
              (h.component = new o(h, l)),
              (h.$root = $(n._.node("div", s(), d.picker)).on({
                focusin: function (e) {
                ...
                click: function (e) {
                  ...
                  t != h.$root.children()[0] &&
                    (e.stopPropagation(),
                    h.$root.find(document.activeElement).length || r.focus(),
                    o.nav && !i.hasClass(d.navDisabled)
                      ? h.set("highlight", h.component.item.highlight, {
                          nav: o.nav,
                        })
                      : n._.isInteger(o.pick) && !i.hasClass(d.disabled)
                      ? h.set({ select: o.pick, highlight: o.pick }).close(!0)
                      : o.clear && h.clear().close(!0));
                },
              })),
              (h._hidden = l.formatSubmit
                ? $(
                    "<input type=hidden name=" +
                      r.name +
                      (l.hiddenSuffix || "_submit") +
                      (m.data("value")
                        ? ' value="' +
                          n._.trigger(
                            h.component.formats.toString,
                            h.component,
                            [l.formatSubmit, h.component.item.select]
                          )
                        : "") +
                      '">'
                  )[0]
              ...
              m
                .addClass(d.input)
                .on("focus.P" + u.id, c)
                .on("click.P" + u.id, h.open)
                .on("change.P" + u.id, function () {
                  h._hidden &&
                    (h._hidden.value = r.value
                      ? n._.trigger(h.component.formats.toString, h.component, [
                          l.formatSubmit,
                          h.component.item.select,
                        ])
                      : "");
                })
                .on("keydown.P" + u.id, function (e) {
                  ...
                  return 27 == n
                    ? (h.close(), !1)
                    : ((32 == n || r || (!u.open && h.component.key[n])) &&
                        (e.preventDefault(),
                        e.stopPropagation(),
                        r ? h.clear().close() : h.open()),
                      t);
                })
                .val(
                  m.data("value")
              ...
              r.autofocus && h.open(),
              h.trigger("start").trigger("render"));
        },
        render: function () {
        ...
        stop: function () {
          return u.start
            ? (h.close(),
              h._hidden && h._hidden.parentNode.removeChild(h._hidden),
              h.$root.remove(),
              m
                .removeClass(d.input)
                .off(".P" + u.id)
        ...
        open: function (t) {
          return u.open
            ? h
            : (m.addClass(d.active),
              h.$root.addClass(d.opened),
              t !== !1 &&
                ((u.open = !0),
                m.focus(),
                e
                  .on("click.P" + u.id + " focusin.P" + u.id, function (e) {
                  ...
                  .on("keydown.P" + u.id, function (e) {
                    ...
                    27 == t
                      ? h.close(!0)
                      : o != r || (!i && 13 != t)
                      ? h.$root.find(o).length &&
                        13 == t &&
                        (e.preventDefault(), o.click())
                      : (e.preventDefault(),
                        i
                          ? n._.trigger(h.component.key.go, h, [i])
                          : h
                              .set("select", h.component.item.highlight)
                              .close());
                  })),
              h.trigger("open"));
        },
        close: function (t) {
          return (
            t &&
              (m.off("focus.P" + u.id).focus(),
              setTimeout(function () {
                m.on("focus.P" + u.id, c);
              }, 0)),
            m.removeClass(d.active),
            h.$root.removeClass(d.opened + " " + d.focused),
            u.open ? ((u.open = !1), e.off(".P" + u.id), h.trigger("close")) : h
          );
        },
        clear: function () {
          return h.set("clear");
        ...
        set: function (e, t, r) {
          ...
          if (e) {
            ...
            for (i in s)
              (o = s[i]),
                h.component.item[i] && h.component.set(i, o, r || {}),
                ("select" == i || "clear" == i) &&
                  m
                    .val(
                      "clear" == i
  ...
  return (
    ...
    (n._ = {
      group: function (e) {
        for (
          var t, r = "", i = n._.trigger(e.min, e);
          n._.trigger(e.max, e, [i]) >= i;
          i += e.i
        )
          (t = n._.trigger(e.item, e, [i])),
            (r += n._.node(e.node, t[0], t[1], t[2]));
        return r;
      },
...
(function () {
  function e(e, t) {
    ...
    (i.settings = t),
      ...
      i
        ...
        .set("max", t.max)
        .set("now")
        .set("select", r || e.$node[0].value || i.item.now, {
          format: r ? t.formatSubmit : t.format,
          data: !!r,
        })
        .set("highlight", i.item.select),
      (i.key = {
        40: 7,
        38: -7,
        39: 1,
        ...
        go: function (e) {
          i.set(
            "highlight",
            [
              i.item.highlight.year,
              i.item.highlight.month,
              i.item.highlight.date + e,
            ],
            { interval: e }
          ),
            this.render();
        ...
        .on("render", function () {
          e.$root.find("." + t.klass.selectMonth).on("change", function () {
            e.set("highlight", [
              ...
              e.$root.find("." + t.klass.selectMonth).focus();
          }),
            e.$root.find("." + t.klass.selectYear).on("change", function () {
              e.set("highlight", [
                ...
                e.$root.find("." + t.klass.selectYear).focus();
            });
        })
        .on("open", function () {
  ...
  (e.prototype.set = function (e, t, i) {
    var r = this;
    return (
      (r.item["enable" == e ? "disable" : "flip" == e ? "enable" : e] = r.queue[
        e
      ]
        .split(" ")
        .map(function (n) {
        ...
        .pop()),
      "select" == e
        ? r.set("highlight", r.item.select, i)
        : "highlight" == e
        ? r.set("view", r.item.highlight, i)
        : ("flip" == e ||
            "min" == e ||
            "max" == e ||
            "disable" == e ||
          ...
          r.item.highlight &&
          r
            .set("select", r.item.select, i)
            .set("highlight", r.item.highlight, i),
      r
    );
  }),
    ...
    (e.prototype.create = function (e, t, i) {
      ...
      return (
        ...
        t == -1 / 0 || 1 / 0 == t
          ? (r = t)
          : (t =
              Picker._.isObject(t) && Picker._.isInteger(t.pick)
                ? t.obj
                : Array.isArray(t)
                ? new Date(t[0], t[1], t[2])
                : Picker._.isInteger(t) || Picker._.isDate(t)
                ? n.normalize(new Date(t), i)
                : n.now(e, t, i)),
        {
    ...
    (e.prototype.navigate = function (e, t, i) {
      return (
        Picker._.isObject(t) &&
          (t = [t.year, t.month + (i && i.nav ? i.nav : 0), t.date]),
        t
      );
    }),
    ...
    (e.prototype.measure = function (e, t) {
      ...
      return (
        t
          ? Picker._.isInteger(t) && (t = i.now(e, t, { rel: t }))
          : (t = "min" == e ? -1 / 0 : 1 / 0),
        t
      );
    }),
    ...
    (e.prototype.validate = function (e, t, i) {
      ...
      return (
        r.disabled(t) && (t = r.shift(t, n)),
        (t = r.scope(t)),
        r.disabled(t) &&
          (t = r.shift(
            t,
            t.pick <= r.item.min.pick ? 1 : t.pick >= r.item.max.pick ? -1 : n
          )),
        t
      );
    }),
    (e.prototype.disabled = function (e) {
      var t = this,
        i = t.item.disable.filter(function (i) {
          return Picker._.isInteger(i)
            ? e.day === (t.settings.firstDay ? i : i - 1) % 7
            : Array.isArray(i)
            ? e.pick === t.create(i).pick
            : void 0;
        }).length;
    ...
    (e.prototype.shift = function (e, t) {
      ...
      for (
        t = t || 1;
        i.disabled(e) &&
        ((e = i.create([e.year, e.month, e.date + t])),
        Math.abs(e.month - r.month) > 2 &&
          ((e = r),
          (t = -1 === i.item.enable ? (0 > t ? 1 : -1) : 0 > t ? -1 : 1)),
        !(e.pick <= i.item.min.pick || e.pick >= i.item.max.pick));
    ...
    (e.prototype.parse = function (e, t, i) {
      ...
      return (
        r.formats.toArray(i.format).map(function (e) {
          var i = r.formats[e],
      ...
      return {
        ...
        toString: function (e, t) {
          ...
          return i.formats
            ...
            .map(function (e) {
              return (
                Picker._.trigger(i.formats[e], i, [0, t]) || e.replace(/^!/, "")
              );
            })
            .join("");
        },
    ...
    (e.prototype.flipItem = function (e, t) {
      ...
      return (
        "flip" == t
          ? (i.item.enable = n ? 1 : -1)
          : (!n && "enable" == e) || (n && "disable" == e)
          ? (r = i.removeDisabled(r, t))
          : ((!n && "disable" == e) || (n && "enable" == e)) &&
            (r = i.addDisabled(r, t)),
        r
      );
    }),
    ...
    (e.prototype.nodes = function (e) {
      var r = this,
        ...
        p = function (e) {
          return n.selectMonths
            ...
            : Picker._.node("div", e[l.month], n.klass.month);
        },
        y = function () {
          var e = l.year,
      ...
      return (
        Picker._.node(
          ...
          m() +
            m(1) +
            p(n.showMonthsShort ? n.monthsShort : n.monthsFull) +
            y(),
          n.klass.header
        ) +
        Picker._.node(
                            ...
                            Picker._.node(
                              ...
                              (function (t) {
                                return (
                                  ...
                                  a.pick == e.pick && t.push(n.klass.now),
                                  o &&
                                    o.pick == e.pick &&
                                    t.push(n.klass.selected),
                                  s &&
                                    s.pick == e.pick &&
                                    t.push(n.klass.highlighted),
                                  ((c && r.disabled(e)) ||
                                    e.pick < u.pick ||
                                    e.pick > d.pick) &&
                                    t.push(n.klass.disabled),
                                  t.join(" ")
                                );
                              })([n.klass.day]),
                              "data-pick=" + e.pick
        ...
        Picker._.node(
          ...
          Picker._.node(
            ...
            n.today,
            n.klass.buttonToday,
            "data-pick=" + a.pick + (e ? "" : " disabled")
          ) +
            Picker._.node(
              "button",
              n.clear,
              n.klass.buttonClear,
              "data-clear=1" + (e ? "" : " disabled")
            ),
          n.klass.footer
        )
      );
