<?php
    ...
    nama VARCHAR(100) NOT NULL,role_ID INT,FOREIGN KEY (role_ID) REFERENCES tb_role(role_ID) , divisi VARCHAR(100), noTelp VARCHAR(20),alamat VARCHAR(100),KTP_NPWP VARCHAR(100)
    )";
    ...
    user_ID INT PRIMARY KEY AUTO_INCREMENT, karyawan_ID INT,FOREIGN KEY (karyawan_ID) REFERENCES tb_karyawan(karyawan_ID)
    )";
        if($conn->query($user)){
            try{
